...
exports.chat = async (req, res) => {
  ...
  try {
    ...
    // Always use mock mode in development for now
    if (process.env.NODE_ENV === 'development') {
      childName = 'Enfant';
      childAge = 10;
      educationalLevel = 'CM2'; // Default level for testing
      ...
      logger.debug('[AI Chat] Sending response:', { aiResponse: aiResponse?.substring(0, 50), quizRequested, mood });
